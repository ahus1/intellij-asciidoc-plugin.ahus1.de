...
Wenn eine Seite aufgerufen wird, die nicht existiert (404), so sammeln wir Informationen über diesen Fehler, so dass wir ggf. unsere Links und Seiten anpassen können.
Hierfür benutzen wir einen Cloud-Service von https://sentry.io/security/[Sentry,opts=nofollow].
Nutzer können auf freiwilliger Basis zusätzliche Angaben zum aufgetretenen Problem machen.
...
Vom Websiteinhaber angepasst. https://datenschutz-generator.de/[Erstellt mit Datenschutz-Generator.de von RA Dr. Thomas Schwenke,opts=nofollow]
